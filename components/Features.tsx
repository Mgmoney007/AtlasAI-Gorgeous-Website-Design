...
const FeatureCard: React.FC<{ feature: FeatureData; colorClasses: any }> = ({ feature, colorClasses }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-40 sm:h-48 mt-12 relative opacity-60 group-hover:opacity-100 transition-all duration-1000 z-10">
        {feature.id === 'velocity' && isVisible && (
      ...
      <div className={`absolute pointer-events-none transition-all duration-1000 opacity-0 group-hover:opacity-100 blur-[120px] rounded-full z-0 ${feature.color === 'lime' ? 'bg-[#BFF549]/15' : `bg-${feature.color}-500/15`
